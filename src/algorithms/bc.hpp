...
namespace algorithms
{
        ...
        graphblas::IndexArrayType const &s)
    {
        ...
        graphblas::DivMonoid<float>            GrB_Flt32Div;  // todo: inverse
        ...
        graphblas::Matrix<float> tmp1(n, nsver);
        //graphblas::Matrix<float> tmp2(p, N);
        ...
        graphblas::Matrix<float> result(n, 0);
