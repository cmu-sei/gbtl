...
/**
 * @file appendix_algorithms.hpp
 *
 * @brief Implementations of C API Specification algorithms (Appendix B)
 *
 */

#ifndef ALGORITHMS_APPENDIX_ALGORITHMS_HPP
#define ALGORITHMS_APPENDIX_ALGORITHMS_HPP
