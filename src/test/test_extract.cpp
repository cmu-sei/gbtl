...
BOOST_AUTO_TEST_CASE(extract_test_bad_dimensions)
{
    ...
    VectorIndexType vect_I({0, 2});
    VectorIndexType vect_J({0, 4, 1, 2});
...
{
    VectorIndexType i_m1    = {0, 0, 0, 1, 1, 1, 2, 2};
    VectorIndexType j_m1    = {1, 2, 3, 0, 2, 3, 0, 1};
    ...
    VectorIndexType vect_I({0,2});
    VectorIndexType vect_J({0,1,3});

    Matrix<double, DirectedMatrixTag> c(2,3);

    VectorIndexType i_result    = {0, 0, 1, 1};
    VectorIndexType j_result    = {1, 2, 0, 1};
...
{
    VectorIndexType i_A    = {0, 0, 0, 1, 1, 1, 2, 2};
    VectorIndexType j_A    = {1, 2, 3, 0, 2, 3, 0, 1};
    std::vector<double> v_A = {1, 2, 3, 4, 6, 7, 8, 9};
    Matrix<double, DirectedMatrixTag> A(3, 4);
    A.build(i_A, j_A, v_A);

    VectorIndexType i_C    = {0, 0, 1, 1};
    VectorIndexType j_C    = {1, 2, 0, 1};
