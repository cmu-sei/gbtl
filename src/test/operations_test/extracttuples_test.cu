...
#define BOOST_TEST_MODULE extracttuples

#include <boost/test/included/unit_test.hpp>

BOOST_AUTO_TEST_SUITE(extracttuples)

BOOST_AUTO_TEST_CASE(extracttuples_arrayTypes)
{
...
BOOST_AUTO_TEST_CASE(extracttuples_iterators)
{
    using namespace graphblas;
    Matrix<int> stuff(4,4);
    //test on iterators:
