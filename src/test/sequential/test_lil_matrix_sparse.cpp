...
BOOST_AUTO_TEST_CASE(lil_test_construction_vector_of_vector_of_scalar)
{
    ...
    GraphBLAS::LilMatrix_sparse<double> m1(mat);
...
BOOST_AUTO_TEST_CASE(lil_test_construction_vector_of_vector_of_tuple)
{
    ...
    GraphBLAS::LilMatrix_sparse<double> m2(0, mat2);
...
BOOST_AUTO_TEST_CASE(lil_test_copy_assignment)
{
    ...
    m1.nrows(M);
    m1.ncols(N);
    GraphBLAS::LilMatrix_sparse<double> m2(M, N);
...
//****************************************************************************
BOOST_AUTO_TEST_CASE(lil_test_get_rows)
{
/*
    std::vector<std::vector<double> > mat = {{6, 0, 0, 4},
                                             {7, 0, 0, 0},
    ...
    graphblas::LilMatrix<double> m1(mat);
    graphblas::IndexType M, N;
    m1.get_shape(M, N);
...
BOOST_AUTO_TEST_CASE(lil_test_transpose_view)
{
    std::vector<std::vector<double> > mat = {{6, 0, 0, 4},
                                             {7, 0, 0, 0},
                                             {0, 0, 9, 4},
...
//****************************************************************************
BOOST_AUTO_TEST_CASE(lil_double_assignment)
{
    std::vector<std::vector<double> > mat = {{6, 0, 0, 4},
                                          {7, 0, 0, 0},
                                          {0, 0, 9, 4},
