...
//****************************************************************************
BOOST_AUTO_TEST_CASE(test_mxm_NoMask_NoAccum_ABT_noncommutative_multiply)
{
    grb::Matrix<double> C(3, 4);
    grb::Matrix<double> A(A_sparse_3x3, 0.);
    grb::Matrix<double> B(BT_sparse_3x4, 0.);
    ...
    grb::mxm(C,
             grb::NoMask(),
             grb::NoAccumulate(),
             grb::MinSecondSemiring<double>(), A, transpose(B));
    for (grb::IndexType ix = 0; ix < answer.nrows(); ++ix)
    {
        for (grb::IndexType iy = 0; iy < answer.ncols(); ++iy)
        {
...
//****************************************************************************
BOOST_AUTO_TEST_CASE(test_mxm_Mask_NoAccum_ABT_noncommutative_multiply)
{
    grb::Matrix<double> C(3, 4);
    grb::Matrix<double> A(A_sparse_3x3, 0.);
    grb::Matrix<double> B(BT_sparse_3x4, 0.);
...
//****************************************************************************
BOOST_AUTO_TEST_CASE(test_mxm_Mask_Accum_ABT_noncommutative_multiply)
{
...
//****************************************************************************
BOOST_AUTO_TEST_CASE(test_mxm_CompMask_NoAccum_ABT_noncommutative_multiply)
{
    grb::Matrix<double> C(3, 4);
    grb::Matrix<double> A(A_sparse_3x3, 0.);
    grb::Matrix<double> B(BT_sparse_3x4, 0.);
...
//****************************************************************************
BOOST_AUTO_TEST_CASE(test_mxm_CompMask_Accum_ABT_noncommutative_multiply)
{
    grb::Matrix<double> C(NotLower_3x4, 0.);
    grb::Matrix<double> A(A_sparse_3x3, 0.);
    grb::Matrix<double> B(BT_sparse_3x4, 0.);
