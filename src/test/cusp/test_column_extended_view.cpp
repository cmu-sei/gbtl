...
BOOST_AUTO_TEST_CASE(cev_test_construction_vector)
{
    ...
    graphblas::COO<double> row_matrix(row_vector);

    graphblas::IndexType num_rows = 3;
    graphblas::ColumnExtendedView<graphblas::COO<double> >
        m1(0,
           row_matrix,
           num_rows);
...
BOOST_AUTO_TEST_CASE(cev_test_construction_row_view)
{
    ...
    graphblas::RowView<graphblas::COO<double> >
    ...
    graphblas::ColumnExtendedView<
        graphblas::RowView<
            graphblas::COO<double> > > cev_mat(0, row_matrix, num_rows);
...
BOOST_AUTO_TEST_CASE(cev_test_construction_matrix_row_index)
{
    ...
    graphblas::IndexType num_rows = 3;
    graphblas::ColumnExtendedView<
        graphblas::COO<double> > cev_mat(orig_row_index,
                                               matrix,
                                               num_rows);
