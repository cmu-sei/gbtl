...
//****************************************************************************
BOOST_AUTO_TEST_CASE(oneb_same_domain_test)
{
    BOOST_CHECK_EQUAL(OneB<double>()(0.0, 0.0), 1.0);
    BOOST_CHECK_EQUAL(OneB<double>()(1.0, 0.0), 1.0);
    BOOST_CHECK_EQUAL(OneB<double>()(0.0, 1.0), 1.0);
    BOOST_CHECK_EQUAL(OneB<double>()(1.0, 1.0), 1.0);

    BOOST_CHECK_EQUAL(OneB<float>()(0.0f, 0.0f), 1.0f);
    BOOST_CHECK_EQUAL(OneB<float>()(1.0f, 0.0f), 1.0f);
    BOOST_CHECK_EQUAL(OneB<float>()(0.0f, 1.0f), 1.0f);
    BOOST_CHECK_EQUAL(OneB<float>()(1.0f, 1.0f), 1.0f);

    BOOST_CHECK_EQUAL(OneB<uint64_t>()(0, 0), 1);
    BOOST_CHECK_EQUAL(OneB<uint64_t>()(1, 0), 1);
    BOOST_CHECK_EQUAL(OneB<uint64_t>()(0, 1), 1);
    BOOST_CHECK_EQUAL(OneB<uint64_t>()(1, 1), 1);

    BOOST_CHECK_EQUAL(OneB<uint32_t>()(0, 0), 1);
    BOOST_CHECK_EQUAL(OneB<uint32_t>()(1, 0), 1);
    BOOST_CHECK_EQUAL(OneB<uint32_t>()(0, 1), 1);
    BOOST_CHECK_EQUAL(OneB<uint32_t>()(1, 1), 1);

    BOOST_CHECK_EQUAL(OneB<uint16_t>()(0, 0), 1);
    BOOST_CHECK_EQUAL(OneB<uint16_t>()(1, 0), 1);
    BOOST_CHECK_EQUAL(OneB<uint16_t>()(0, 1), 1);
    BOOST_CHECK_EQUAL(OneB<uint16_t>()(1, 1), 1);

    BOOST_CHECK_EQUAL(OneB<uint8_t>()(0, 0), 1);
    BOOST_CHECK_EQUAL(OneB<uint8_t>()(1, 0), 1);
    BOOST_CHECK_EQUAL(OneB<uint8_t>()(0, 1), 1);
    BOOST_CHECK_EQUAL(OneB<uint8_t>()(1, 1), 1);

    BOOST_CHECK_EQUAL(OneB<int64_t>()(0, 0), 1);
    BOOST_CHECK_EQUAL(OneB<int64_t>()(-1, 0), 1);
    BOOST_CHECK_EQUAL(OneB<int64_t>()(0, -1), 1);
    BOOST_CHECK_EQUAL(OneB<int64_t>()(-1, -1), 1);

    BOOST_CHECK_EQUAL(OneB<int32_t>()(0, 0), 1);
    BOOST_CHECK_EQUAL(OneB<int32_t>()(-1, 0), 1);
    BOOST_CHECK_EQUAL(OneB<int32_t>()(0, -1), 1);
    BOOST_CHECK_EQUAL(OneB<int32_t>()(-1, -1), 1);

    BOOST_CHECK_EQUAL(OneB<int16_t>()(0, 0), 1);
    BOOST_CHECK_EQUAL(OneB<int16_t>()(-1, 0), 1);
    BOOST_CHECK_EQUAL(OneB<int16_t>()(0, -1), 1);
    BOOST_CHECK_EQUAL(OneB<int16_t>()(-1, -1), 1);

    BOOST_CHECK_EQUAL(OneB<int8_t>()(0, 0), 1);
    BOOST_CHECK_EQUAL(OneB<int8_t>()(-1, 0), 1);
    BOOST_CHECK_EQUAL(OneB<int8_t>()(0, -1), 1);
    BOOST_CHECK_EQUAL(OneB<int8_t>()(-1, -1), 1);

    BOOST_CHECK_EQUAL(OneB<bool>()(false, false), true);
    BOOST_CHECK_EQUAL(OneB<bool>()(false, true),  true);
    BOOST_CHECK_EQUAL(OneB<bool>()(true, false),  true);
    BOOST_CHECK_EQUAL(OneB<bool>()(true, true),   true);
}

//****************************************************************************
BOOST_AUTO_TEST_CASE(oneb_different_domain_test)
{
    BOOST_CHECK_EQUAL((OneB<double,bool    >()(0.2, true)), 1.);
    BOOST_CHECK_EQUAL((OneB<double,int32_t >()(1.2, 0)), 1.);
    BOOST_CHECK_EQUAL((OneB<double,uint64_t>()(0.2, 1UL)), 1.);
    BOOST_CHECK_EQUAL((OneB<double,float   >()(1.2, 1.0f)), 1.);

    BOOST_CHECK_EQUAL((OneB<float,bool    >()(0.1f, false)), 1.f);
    BOOST_CHECK_EQUAL((OneB<float,double  >()(1.1f, 0.2)), 1.f);
    BOOST_CHECK_EQUAL((OneB<float,uint64_t>()(0.1f, 1UL)), 1.f);
    BOOST_CHECK_EQUAL((OneB<float,int32_t >()(1.1f, 1)), 1.f);

    BOOST_CHECK_EQUAL((OneB<uint64_t,bool    >()(0, false)), 1);
    BOOST_CHECK_EQUAL((OneB<uint64_t,int32_t >()(1, 0)), 1);
    BOOST_CHECK_EQUAL((OneB<uint64_t,uint64_t>()(0, 1)), 1);
    BOOST_CHECK_EQUAL((OneB<uint64_t,float   >()(1, 1.1f)), 1);

    BOOST_CHECK_EQUAL((OneB<uint32_t,bool    >()(0, false)), 1);
    BOOST_CHECK_EQUAL((OneB<uint32_t,int32_t >()(1, 0)), 1);
    BOOST_CHECK_EQUAL((OneB<uint32_t,uint64_t>()(0, 1)), 1);
    BOOST_CHECK_EQUAL((OneB<uint32_t,float   >()(1, 1)), 1);

    BOOST_CHECK_EQUAL((OneB<uint16_t,bool    >()(0, false)),1);
    BOOST_CHECK_EQUAL((OneB<uint16_t,int32_t >()(1, 0)),    1);
    BOOST_CHECK_EQUAL((OneB<uint16_t,uint64_t>()(0, 1)),    1);
    BOOST_CHECK_EQUAL((OneB<uint16_t,float   >()(1, 1.1f)), 1);

    BOOST_CHECK_EQUAL((OneB<uint8_t,bool    >()(0, false)), 1);
    BOOST_CHECK_EQUAL((OneB<uint8_t,int32_t >()(1, 0)),     1);
    BOOST_CHECK_EQUAL((OneB<uint8_t,uint64_t>()(0, 1)),     1);
    BOOST_CHECK_EQUAL((OneB<uint8_t,float   >()(1, 1.1f)),  1);

    BOOST_CHECK_EQUAL((OneB<int64_t,bool    >()( 0,  false)),1);
    BOOST_CHECK_EQUAL((OneB<int64_t,uint32_t>()(-1,  0)),    1);
    BOOST_CHECK_EQUAL((OneB<int64_t,int64_t >()( 0, -1)),    1);
    BOOST_CHECK_EQUAL((OneB<int64_t,float   >()(-1, -1.1f)), 1);

    BOOST_CHECK_EQUAL((OneB<int32_t,bool    >()( 0,  false)),1);
    BOOST_CHECK_EQUAL((OneB<int32_t,uint32_t>()(-1,  0)),    1);
    BOOST_CHECK_EQUAL((OneB<int32_t,int64_t >()( 0, -1)),    1);
    BOOST_CHECK_EQUAL((OneB<int32_t,float   >()(-1, -1.1f)), 1);

    BOOST_CHECK_EQUAL((OneB<int16_t,bool    >()( 0,  false)),1);
    BOOST_CHECK_EQUAL((OneB<int16_t,uint32_t>()(-1,  0)),    1);
    BOOST_CHECK_EQUAL((OneB<int16_t,int64_t >()( 0, -1)),    1);
    BOOST_CHECK_EQUAL((OneB<int16_t,float   >()(-1, -1.1f)), 1);

    BOOST_CHECK_EQUAL((OneB<int8_t,bool    >()( 0,  false)), 1);
    BOOST_CHECK_EQUAL((OneB<int8_t,uint32_t>()(-1,  0)),     1);
    BOOST_CHECK_EQUAL((OneB<int8_t,int64_t> ()( 0, -1)),     1);
    BOOST_CHECK_EQUAL((OneB<int8_t,float   >()(-1, -1.f)),   1);

    BOOST_CHECK_EQUAL((OneB<bool,int8_t  >()(false, 0)),   true);
    BOOST_CHECK_EQUAL((OneB<bool,int32_t >()(false, 1)),   true);
    BOOST_CHECK_EQUAL((OneB<bool,uint64_t>()(true,  0UL)), true);
    BOOST_CHECK_EQUAL((OneB<bool,float   >()(true,  1.1f)),true);
}
