...
namespace grb
{
    ...
    {
        //template <typename T>
        //using NWGraphMatrix = LilSparseMatrix<T>;

        //template <typename T>
        //using NWGraphVector = BitmapSparseVector<T>;
        ...
        template<>
        struct substitute<grb::detail::ImplementationCategoryTag, grb::NWGraphTag> {
            using type = grb::NWGraphTag;
        };
        ...
        struct vector_generator {
            ...
            // special case returns the backend NWGraph vector type
            template<typename ScalarT,
                     typename Implementation, typename Sparseness,
                     typename... TagsT>
            struct result<ScalarT,
                          ...
                          grb::NWGraphTag, TagsT...>
            {
                using type = BitmapSparseVector<ScalarT>; //NWGraphVector<ScalarT>;
            };
