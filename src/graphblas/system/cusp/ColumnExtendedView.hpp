...
#ifndef GB_CUSP_COLUMN_EXTENDED_VIEW_HPP
#define GB_CUSP_COLUMN_EXTENDED_VIEW_HPP
...
namespace graphblas
{
    ...
    public:
        ...
        ScalarType get_value_at(IndexType row, IndexType col) const
        {
            ...
            return m_matrix.get_value_at(m_row_index, col);
        }
...
#endif // GB_CUSP_COLUMN_EXTENDED_VIEW_HPP
